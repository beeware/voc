...
public class Object implements org.python.Object {
    ...
    public org.python.Object __radd__(org.python.Object other) {
        throw new org.python.exceptions.TypeError("unsupported operand type(s) for + (reversed): '" + other.typeName() + "' and '" + this.typeName() + "'");
    }
    ...
    public org.python.Object __rdivmod__(org.python.Object other) {
        throw new org.python.exceptions.TypeError("unsupported operand type(s) for divmod (reversed): '" + other.typeName() + "' and '" + this.typeName() + "'");
    }
    ...
    public org.python.Object __rpow__(org.python.Object other) {
        throw new org.python.exceptions.TypeError("unsupported operand type(s) for ^ or pow() (reversed): '" + other.typeName() + "' and '" + this.typeName() + "'");
    }
